...
final class Version20190109115503 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `duel` (id INT AUTO_INCREMENT NOT NULL, joueur1_id INT DEFAULT NULL, joueur2_id INT DEFAULT NULL, tournament_id INT DEFAULT NULL, vainqueur_id INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_7A5BC50592C1E237 (joueur1_id), INDEX IDX_7A5BC50580744DD9 (joueur2_id), INDEX IDX_7A5BC50533D1A3E7 (tournament_id), INDEX IDX_7A5BC505773C35EE (vainqueur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `duel` ADD CONSTRAINT FK_7A5BC50592C1E237 FOREIGN KEY (joueur1_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE `duel` ADD CONSTRAINT FK_7A5BC50580744DD9 FOREIGN KEY (joueur2_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE `duel` ADD CONSTRAINT FK_7A5BC50533D1A3E7 FOREIGN KEY (tournament_id) REFERENCES tournament (id)');
        $this->addSql('ALTER TABLE `duel` ADD CONSTRAINT FK_7A5BC505773C35EE FOREIGN KEY (vainqueur_id) REFERENCES user (id)');
    }
